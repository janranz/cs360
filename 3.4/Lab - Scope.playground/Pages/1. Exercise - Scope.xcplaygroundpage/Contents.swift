...
/*
    Compiler error occurs on line 10 because the 'foo' that is being referenced only exists within the scope of the for loop
 */
/*:
...
/*
    In this case, variable 'x' exists within a scope that both the for loop and the outer print function resides. Global
 */
/*:
...
greeting(greeting: "YO WHAT IS UP", name: "Karen")
greeting(greeting: nil, name: "Andy")
/*:
