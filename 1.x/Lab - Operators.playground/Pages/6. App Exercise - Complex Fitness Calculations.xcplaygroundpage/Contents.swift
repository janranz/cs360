 ...
 */
let heart1: Double = 60
let heart2: Double = 80
let heart3: Double = 100

let avgHR = ((heart1 + heart2 + heart3) / 3)
 ...
 */
let tempInFah: Double = 98.6

let cels: Double = ((tempInFah - 32) * (5.0/9.0))
