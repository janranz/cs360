 ...
 */
var numberOfLikes = 0    // value can vary through the lifetime of the program
var numberOfComments = 0 // value can vary through the lifetime of the program
let yearCreated = 0      // value will not change
let monthCreated = 0     // value will not change
let dayCreated = 0       // value will not change
