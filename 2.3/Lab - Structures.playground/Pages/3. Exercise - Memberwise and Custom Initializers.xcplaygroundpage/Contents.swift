...
let favoriteBook = Book(title: "Cell", author: "Stephen King", pages: 537, price: 12.99)
print(favoriteBook)
/*:
...
struct Height
{
    ...
    init(hin: Double)
    {
        self.heightInInches = hin
        self.heightInCentimeters = hin * 2.54
    }
}

//let howHigh = Height(hin: 65)
 ...
 */
let someonesHeight = Height(hin: 65)
