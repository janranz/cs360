...
class Spaceship {
    ...
    func wasHit() {
        health -= 5
        if health <= 0 {
            print("Health: \(self.health) Sorry, your ship was hit one too many times. Do you want to play again?")
        }
    }
}
...
class ShieldedShip:Fighter
{
    ...
    override func wasHit() {
        if self.shieldStrength > 0
        {
            ...
            print("Shield Hit taken. Health:\(self.health) Shield Strength: \(self.shieldStrength)")
