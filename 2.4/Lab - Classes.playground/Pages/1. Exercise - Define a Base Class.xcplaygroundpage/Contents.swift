...
class Spaceship
{
    var name: String = ""
    var health: Int = 0
    var position: Int = 0 //negative: Left Positive: right
    ...
    func wasHit()
    {
        if self.health <= 0
        {
            print("Ship was destroyed, would you like to play again?")
        } else
        {
            self.health -= 5
            print("Ship was hit! Health: \(self.health).")
        }
    }
}
