...
class Fighter: Spaceship
{
    ...
    func fire()
    {
        if remainingFirePower > 0
        {
            ...
            print("Remaining Firepower: \(self.remainingFirePower)")
        } else
        {
            print("You have no firepower: \(self.remainingFirePower)")
        }
    }
}
 ...
 */
// Falcon class (parent) does not inherit it's child class members.
