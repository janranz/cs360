...
//print((meals["Breakfast"]?.calories)!)
func mealLogger(entry: String) -> Meal?
{
    return(meals[entry])
}
var result3 = mealLogger(entry: "Breakfast")
print("Food Item(s): \((result3?.food)!) Calories: \((result3?.calories)!)")
/*:
