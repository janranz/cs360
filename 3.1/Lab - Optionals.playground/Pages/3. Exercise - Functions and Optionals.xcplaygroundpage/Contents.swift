...
func checkAge(age: Int?) -> Int?
{
    if age == nil
    {
        print("Sorry, something went wrong. Please re-enter your age.")
        return(age)
    }
    if age! > 18
    {
    ...
    {
        print("Sorry, but you must be over 18 years old to use this app.")
        return(age!)
    }
}
var result = checkAge(age: Int(userInputAge))
/*:
...
func priceCheck(itemName: String) -> Int?
{
    if let itemStock = stock[itemName]
    {
        print("Item found!")
        return(itemStock)
    } else
...
var result2 : Int? = priceCheck(itemName: "Chips")

if result2 != nil
{
    print("Item stock: \(result2!)")
}
